...
supersedes: []
evidence:
  - "replayglowz_app/lib/screens/feedback/feedback_screen.dart"
  - "replayglowz_app/lib/screens/feedback/feedback_admin_screen.dart"
...
Date: 2026-04-19
Branche front: `main`
Frontend repo: `replayglowz_app`
Backend Convex repo: `/home/claude/replayglowz/replayglowz_backend/packages/backend/convex`
...
- Le backend Convex vit dans un autre repo: `/home/claude/replayglowz/replayglowz_backend/packages/backend/convex`.
...
- Le web déployé via Vercel bloque explicitement le micro dans [vercel.json](replayglowz_app/vercel.json:1); l’audio web ne peut pas fonctionner sans changement de headers.
...
- La navigation secondaire naturelle pour une zone admin discrète est l’écran [preferences_screen.dart](replayglowz_app/lib/screens/preferences/preferences_screen.dart:1).
- Le pattern d’écran admin/listing le plus proche est [hidden_screen.dart](replayglowz_app/lib/screens/hidden/hidden_screen.dart:1).
...
Nouvelle table `feedbackEntries` dans `/home/claude/replayglowz/replayglowz_backend/packages/backend/convex/schema.ts`.
...
Nouveau module: `/home/claude/replayglowz/replayglowz_backend/packages/backend/convex/feedback.ts`
...
- Route publique `Routes.feedback` ajoutée dans [router.dart](replayglowz_app/lib/app/router.dart:1).
- Point d’entrée authentifié depuis `Preferences`.
- Point d’entrée non authentifié depuis [auth_gate.dart](replayglowz_app/lib/auth/auth_gate.dart:1).
...
- [ ] Tâche 1: Ajouter le schéma feedback côté Convex
  - Fichier: `/home/claude/replayglowz/replayglowz_backend/packages/backend/convex/schema.ts`
  - Action: créer la table `feedbackEntries` avec ses validateurs et indexes.

- [ ] Tâche 2: Créer le module backend feedback
  - Fichier: `/home/claude/replayglowz/replayglowz_backend/packages/backend/convex/feedback.ts`
...
- [ ] Tâche 20: Régénérer les artefacts si nécessaire
  - Fichier: `/home/claude/replayglowz/replayglowz_backend/packages/backend/convex/_generated/*`
...
Backend files: `/home/claude/replayglowz/replayglowz_backend/packages/backend/convex/schema.ts`, `/home/claude/replayglowz/replayglowz_backend/packages/backend/convex/feedback.ts`
─────────────────────────
