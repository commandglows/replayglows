...
This repository is the public marketing site for ReplayGlows. It is an Astro site with static pages for acquisition, SEO, pricing, product education, and a small blog.

## Working assumptions

- The site is content-first and mostly static.
- Primary conversion targets point to the ReplayGlows app, usually `appUrl('/videos')`.
...
- `src/pages/compare.astro`: comparison page positioning ReplayGlows against YouTube
