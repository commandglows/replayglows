...
| 2026-06-12 | Design: authority baseline (app + site) | — | C | — | — | — | — | — | — | C | Baseline check captured with `--warn-only`: 510 findings in `app` and 70 findings in `site`; baseline documented in `shipflow_data/technical/design-system-authority.md` |
