...
owner_routes:
  ...
  - sf-spec
evidence:
  - "Visible conversation context in the active Codex thread; no stored transcript file found under shipflow_data/workflow/conversations/."
...
depends_on:
  ...
  - artifact: "skills/references/spec-driven-development-discipline.md"
    ...
    required_status: active
supersedes: []
next_step: "/sf-spec shipflow-skill-reporting-and-proof-hardening"
---
...
- Source transcript: live conversation context; no stored transcript file was available in `shipflow_data/workflow/conversations/`.
- Audit mode: `default`
...
- recommended_chantier: `shipflow-skill-reporting-and-proof-hardening`
- suggested next command: `/sf-spec shipflow-skill-reporting-and-proof-hardening`

## Chantier potentiel

- title: ShipFlow skill reporting and proof hardening
...
- `/sf-spec shipflow-skill-reporting-and-proof-hardening`
