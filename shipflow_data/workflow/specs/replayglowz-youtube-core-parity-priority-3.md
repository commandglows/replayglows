...
updated: "2026-05-25"
updated_at: "2026-05-25 19:18:21 UTC"
status: ready
...
- Local contracts:
  ...
  - `replayglowz_app/lib/screens/notes/note_detail_screen.dart`
  ...
  - `replayglowz_app/lib/i18n/translations.dart`
...
- Update `replayglowz_app/AGENT.md` only if a new settings UX contract becomes a maintained runtime boundary.
...
- [x] Task 1: Define UX settings contract.
  - File: `replayglowz_app/lib/models/settings.dart`, `replayglowz_backend/packages/backend/convex/schema.ts`, `replayglowz_backend/packages/backend/convex/settings.ts`.
...
- [x] Task 2: Add reusable dismissible helper UI.
  - File: `replayglowz_app/lib/widgets/`, `replayglowz_app/lib/providers/providers.dart`, `replayglowz_app/lib/providers/mutations.dart`.
...
- [x] Task 3: Wire first-run and empty-state onboarding.
  - File: `replayglowz_app/lib/widgets/youtube_connect_ui_states.dart`, `replayglowz_app/lib/screens/videos/videos_screen.dart`, `replayglowz_app/lib/screens/playlists/playlists_screen.dart`, `replayglowz_app/lib/screens/preferences/preferences_screen.dart`.
...
- [x] Task 4: Persist feed, playlist and notes view preferences.
  - File: `replayglowz_app/lib/screens/videos/videos_screen.dart`, `replayglowz_app/lib/screens/playlists/playlists_screen.dart`, `replayglowz_app/lib/screens/notes/notes_screen.dart`, settings model/providers.
...
- [x] Task 5: Add bounded scroll restoration.
  - File: `replayglowz_app/lib/screens/videos/videos_screen.dart`, `replayglowz_app/lib/screens/playlists/playlists_screen.dart`, `replayglowz_app/lib/screens/playlists/playlist_detail_screen.dart`, possibly new local state helper.
...
- [x] Task 7: Complete P3 i18n coverage.
  ...
  - Validate with: `rg -n "TODO: Copy remaining|hard-coded target strings" replayglowz_app/lib/i18n replayglowz_app/lib/screens replayglowz_app/lib/widgets` plus Flutter analyze.
...
- [x] Task 8: Add tests, audit update and master-checklist seed.
  - File: `replayglowz_app/test/`, `shipflow_data/workflow/audits/2026-05-25-tubeflow-expo-feature-gap.md`, new checklist artifact only after implementation if requested in the same run.
  ...
  - Validate with: Flutter analyze, targeted Flutter tests, backend typecheck if backend touched, ShipFlow metadata lint.
...
- [x] Static checks pass: Flutter analyze, backend typecheck if backend touched, targeted tests and ShipFlow metadata lint.
...
- Static checks:
  ...
  - `(cd replayglowz_backend/packages/backend && npm run typecheck)` if schema/settings touched
  - `/home/claude/shipflow/tools/shipflow_metadata_lint.py AGENTS.md shipflow_data`
- Source checks:
  - `rg -n "search\\.list|youtubeAccessToken|refreshToken|clientSecret" replayglowz_app/lib replayglowz_backend/packages/backend/convex`
  - `rg -n "TODO: Copy remaining|TODO: share|TODO: show" replayglowz_app/lib`
- Manual QA:
