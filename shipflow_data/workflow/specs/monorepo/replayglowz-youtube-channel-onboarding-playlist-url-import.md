...
- If a new backend import contract becomes central, update `app/AGENT.md` or `shipflow_data/technical/architecture.md` only after implementation verifies the final shape.
...
- [x] Task 9: Add regression tests and source checks.
  - File: `app/test/`, backend test location if available, `shipflow_data/workflow/audits/2026-05-26-youtube-edge-case-regression-checklist.md`.
