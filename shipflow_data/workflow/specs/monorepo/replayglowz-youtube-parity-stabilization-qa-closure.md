...
depends_on:
  ...
  - artifact: "shipflow_data/workflow/audits/2026-05-26-replayglowz-prod-qa-followups.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipflow_data/workflow/bugs/app/BUG-2026-05-26-001.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipflow_data/workflow/bugs/app/BUG-2026-05-26-002.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipflow_data/workflow/bugs/app/BUG-2026-05-26-003.md"
    artifact_version: "0.1.0"
    required_status: "draft"
...
- Update `shipflow_data/workflow/bugs/app/BUG-2026-05-26-001.md`, `shipflow_data/workflow/bugs/app/BUG-2026-05-26-002.md`, and `shipflow_data/workflow/bugs/app/BUG-2026-05-26-003.md` with fix attempts, retests and closure status.
...
- [ ] Task 1: Confirm baseline and attach active bugs to this chantier.
  - File: `shipflow_data/workflow/bugs/app/BUG-2026-05-26-001.md`, `shipflow_data/workflow/bugs/app/BUG-2026-05-26-002.md`, `shipflow_data/workflow/bugs/app/BUG-2026-05-26-003.md`, `shipflow_data/workflow/audits/2026-05-26-replayglowz-prod-qa-followups.md`.
...
- [ ] Task 4: Reproduce and close the hidden quota-spend question.
  - File: `backend/packages/backend/convex/youtube.ts`, `backend/packages/backend/convex/metrics.ts`, `app/lib/providers/providers.dart`, `app/lib/widgets/app_shell.dart`, `shipflow_data/workflow/bugs/app/BUG-2026-05-26-003.md`.
...
- [ ] Task 11: Run focused checks and deployment verification.
  ...
  - Action: Run `(cd app && flutter analyze)`, `(cd backend/packages/backend && npm run typecheck)` if backend changed, `/home/claude/shipflow/tools/shipflow_metadata_lint.py AGENT.md shipflow_data`, then preview/prod browser QA according to deployment mode.
...
- [ ] Task 12: Close the stabilization records.
  - File: `TEST_LOG.md`, `shipflow_data/workflow/bugs/app/BUG-2026-05-26-001.md`, `shipflow_data/workflow/bugs/app/BUG-2026-05-26-002.md`, `shipflow_data/workflow/bugs/app/BUG-2026-05-26-003.md`, `shipflow_data/workflow/audits/2026-05-26-replayglowz-prod-qa-followups.md`, this spec.
