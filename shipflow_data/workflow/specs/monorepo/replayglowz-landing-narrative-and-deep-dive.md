...
depends_on:
  ...
  - artifact: "shipflow_data/technical/site/guidelines.md"
    ...
    required_status: "reviewed"
supersedes:
  - artifact: "shipflow_data/workflow/specs/monorepo/replayglowz-harmonize-landing-benefits-features-cards.md"
...
- `shipflow_data/product/app/product.md` is canonical product truth; the site and GTM contracts govern public framing.
...
- Do not create a parallel `shipglowz_data/` corpus; this repository explicitly uses `shipflow_data/`.
...
- Read first: `site/AGENT.md`, `CLAUDE.md`, `shipflow_data/technical/design-system-authority.md`, product/GTM contracts, current homepage components, both locale files, and both homepage entrypoints.
