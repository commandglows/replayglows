...
- [x] Task 9: Add or update worker agent guidance if source files change
  ...
  - Validate with: `/home/claude/shipflow/tools/shipflow_metadata_lint.py lab/AGENT.md`.
...
- Forbidden files: `app/**`, `lab/**`, root `README.md`, `.github/**`, `shipflow_data/workflow/bugs/app/**`, and `specs/**`.
...
- Forbidden files: `app/**`, `site/**`, root `README.md`, `.github/**`, `shipflow_data/workflow/bugs/app/**`, and `specs/**`.
...
- Forbidden files: `app/lib/auth/auth_gate.dart`, other unrelated dirty app source files, `site/**`, `lab/**`, root `README.md`, root `.github/**`, `shipflow_data/workflow/bugs/app/**`, and `specs/**`.
...
- Forbidden files: `shipflow_data/workflow/bugs/app/**`, `app/lib/auth/auth_gate.dart`, and any subproject files already owned by active Batch A, B, or C workers.
