...
supersedes: []
evidence:
  - "app/lib/screens/feedback/feedback_screen.dart"
  - "app/lib/screens/feedback/feedback_admin_screen.dart"
...
- Le web déployé via Vercel bloque explicitement le micro dans [vercel.json](app/vercel.json:1); l’audio web ne peut pas fonctionner sans changement de headers.
...
- La navigation secondaire naturelle pour une zone admin discrète est l’écran [preferences_screen.dart](app/lib/screens/preferences/preferences_screen.dart:1).
- Le pattern d’écran admin/listing le plus proche est [hidden_screen.dart](app/lib/screens/hidden/hidden_screen.dart:1).
...
- Route publique `Routes.feedback` ajoutée dans [router.dart](app/lib/app/router.dart:1).
- Point d’entrée authentifié depuis `Preferences`.
- Point d’entrée non authentifié depuis [auth_gate.dart](app/lib/auth/auth_gate.dart:1).
