...
- [x] Task 8: Add tests, audit update and master-checklist seed.
  - File: `app/test/`, `shipflow_data/workflow/audits/2026-05-25-tubeflow-expo-feature-gap.md`, new checklist artifact only after implementation if requested in the same run.
