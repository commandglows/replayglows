...
depends_on:
  ...
  - artifact: "shipflow_data/workflow/conversation-audits/2026-06-09-replayglowz-skill-application-audit.md"
    artifact_version: "1.0.0"
    required_status: "draft"
supersedes: []
evidence:
...
ShipFlow skill reporting and proof hardening
...
- System effect: Shared ShipFlow contracts and affected skill instructions make `report=user` compact by default, `report=agent` detailed by explicit mode, and proof gaps visible before completion claims.
...
- Validate ShipFlow skill budget and sync checks after edits.

## Scope Out

- Rewriting every ShipFlow skill from scratch.
...
- Replacing ShipFlow lifecycle steps or removing chantier tracking.
...
- Skill changes must be made in `/home/claude/shipflow`, while this chantier spec and audit evidence live in the current project governance registry.

## Dependencies

- Runtime: Local ShipFlow skill files and templates under `/home/claude/shipflow`.
- Document contracts:
...
- Fresh external docs verdict: `fresh-docs not needed` because the work changes local ShipFlow skill contracts, templates, and validation scripts only. No external framework, SDK, API, auth provider, migration behavior, or service contract is being introduced.
...
- Update shared ShipFlow references that define reporting, questions, and proof discipline.
...
- No ReplayGlowz product docs need updates because this is a ShipFlow workflow improvement, not an app feature.
...
- [ ] Task 1: Harden user-mode reporting contract.
  ...
  - Depends on: None
  - Validate with: `rg -n "human|report=user|report=agent|checklist|proof" /home/claude/shipflow/skills/references/reporting-contract.md`
  - Notes: Do not remove failure-rule detail; concise must remain actionable.

- [ ] Task 2: Strengthen autonomy and question threshold.
  - File: `/home/claude/shipflow/skills/references/question-contract.md`
  ...
  - Depends on: Task 1
  - Validate with: `rg -n "safe default|autonom|numbered|material" /home/claude/shipflow/skills/references/question-contract.md`
...
- [ ] Task 3: Make `sf-ready` compact for humans and strict internally.
  - File: `/home/claude/shipflow/skills/sf-ready/SKILL.md`
  ...
  - Validate with: `rg -n "report=user|report=agent|checklist|question|artifact_version|ready" /home/claude/shipflow/skills/sf-ready/SKILL.md`
...
- [ ] Task 4: Harden ready metadata transitions.
  ...
  - Depends on: Task 3
  - Validate with: `rg -n "artifact_version|updated_at|metadata lint|Current Chantier Flow|ready" /home/claude/shipflow/skills/sf-ready/SKILL.md`
...
- [ ] Task 5: Add proof-claim discipline for implementation/fix reports.
  - File: `/home/claude/shipflow/skills/references/spec-driven-development-discipline.md`
  ...
  - Depends on: Task 1
  - Validate with: `rg -n "proof path|proof gap|claim|Flutter|UI" /home/claude/shipflow/skills/references/spec-driven-development-discipline.md`
...
- [ ] Task 6: Align readiness template with compact/handoff modes.
  - File: `/home/claude/shipflow/templates/artifacts/readiness_report.md`
...
- Integration: ShipFlow skill validation commands and targeted `rg` checks verify that required contract language exists in the correct files.
...
- Stack/surface: ShipFlow skills, shared references, templates, and validation scripts.
...
- Needed: yes
- Checklist path: `shipflow_data/workflow/test-checklists/shipflow-skill-reporting-and-proof-hardening.md`
...
- Automated / unit / integration checks:
  - `(cd /home/claude/shipflow && python3 tools/skill_budget_audit.py --skills-root skills --format markdown)`
  - `(cd /home/claude/shipflow && tools/shipflow_sync_skills.sh --check --all)`
  - `/home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/workflow/specs/shipflow-skill-reporting-and-proof-hardening.md`
...
- Read first:
  - `/home/claude/shipflow/skills/references/reporting-contract.md`
  - `/home/claude/shipflow/skills/references/question-contract.md`
  - `/home/claude/shipflow/skills/references/spec-driven-development-discipline.md`
  - `/home/claude/shipflow/skills/sf-ready/SKILL.md`
  - `/home/claude/shipflow/templates/artifacts/readiness_report.md`
