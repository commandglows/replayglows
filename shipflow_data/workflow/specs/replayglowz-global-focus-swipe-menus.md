...
evidence:
  ...
  - "Current code has Play-local focus mode in replayglowz_app/lib/screens/play/play_screen.dart."
  - "Current code has global bottom-bar playback swipe behavior in replayglowz_app/lib/widgets/app_shell.dart."
  - "Current i18n already contains fullscreen/focus labels in replayglowz_app/lib/i18n/en.dart and fr.dart."
...
- Global focus mode state in `replayglowz_app`.
...
- `checklist_path`: `shipflow_data/workflow/test-checklists/replayglowz-global-focus-swipe-menus.md`.
- `automated_commands`:
  - `(cd replayglowz_app && flutter analyze)`
  - `(cd replayglowz_app && flutter test test/widgets/app_shell_playback_swipe_test.dart test/app/playback_session_provider_test.dart)`
...
- Local Flutter app code under `replayglowz_app/lib`.
- Existing Riverpod providers:
  - `appPlaybackControllerProvider`
  - `activePlayVideoIdProvider`
  - `playbackSessionProvider`
- Existing routes in `replayglowz_app/lib/app/router.dart`.
- Existing i18n files:
  - `replayglowz_app/lib/i18n/en.dart`
  - `replayglowz_app/lib/i18n/fr.dart`
- Product context: `shipflow_data/business/apps/replayglowz_app/product.md` version `1.2.0`.
- Branding context: `shipflow_data/business/apps/replayglowz_app/branding.md` version `1.0.0`.
...
- [ ] Task 1: Model global focus mode in the app shell.
  - File: `replayglowz_app/lib/widgets/app_shell.dart`
...
- [ ] Task 2: Bridge Play-local focus mode to global focus mode.
  - File: `replayglowz_app/lib/screens/play/play_screen.dart`
...
- [ ] Task 3: Create a page menu contract.
  - File: `replayglowz_app/lib/widgets/app_shell.dart` or a new `replayglowz_app/lib/widgets/focus/page_action_menu.dart`
...
- [ ] Task 5: Add Feed focus menu.
  - File: `replayglowz_app/lib/screens/videos/videos_screen.dart` and shell/menu files.
...
- [ ] Task 6: Add Lists focus menu.
  - File: `replayglowz_app/lib/screens/playlists/playlists_screen.dart`, `playlist_detail_screen.dart`, `virtual_feed_detail_screen.dart`, and shell/menu files.
...
- [ ] Task 7: Implement Lists root local sort.
  - File: `replayglowz_app/lib/screens/playlists/playlists_screen.dart`
...
- [ ] Task 8: Add Notes focus menu.
  - File: `replayglowz_app/lib/screens/notes/notes_screen.dart` and shell/menu files.
...
- [ ] Task 9: Hide normal chrome in focus mode.
  - File: `replayglowz_app/lib/widgets/app_shell.dart` and primary screen app bars where needed.
...
- [ ] Task 11: Add validation checklist.
  - File: `shipflow_data/workflow/test-checklists/replayglowz-global-focus-swipe-menus.md`
...
- Add or extend `replayglowz_app/test/widgets/app_shell_playback_swipe_test.dart` for:
  - focus mode gating;
...
- Run:
  ...
  - `(cd replayglowz_app && flutter test test/widgets/app_shell_playback_swipe_test.dart test/app/playback_session_provider_test.dart)`
- Manual proof:
  - execute every scenario ID in `shipflow_data/workflow/test-checklists/replayglowz-global-focus-swipe-menus.md`;
