...
- Automated evidence
  - `(cd app && flutter analyze)` PASS/FAIL.
  - `(cd app && flutter test <targeted feed/pagination tests>)` PASS/FAIL.
  - `(cd backend/packages/backend && npm run typecheck)` PASS/FAIL if query contract changed.
