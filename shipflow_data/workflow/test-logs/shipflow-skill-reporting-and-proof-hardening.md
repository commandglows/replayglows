...
scope: "shipflow-skill-reporting-and-proof-hardening"
owner: "Diane"
target_scope: "shipflow_data/workflow/test-checklists/shipflow-skill-reporting-and-proof-hardening.md"
stack_profile: "shipflow"
...
docs_impact: yes
evidence:
  - "shipflow_data/workflow/specs/shipflow-skill-reporting-and-proof-hardening.md"
depends_on:
  - artifact: "shipflow_data/workflow/specs/shipflow-skill-reporting-and-proof-hardening.md"
    artifact_version: "1.0.0"
...
# Manual Test Checklist: ShipFlow Skill Reporting And Proof Hardening

## Contract

- Target scope: `shipflow_data/workflow/test-checklists/shipflow-skill-reporting-and-proof-hardening.md`
- Stack profile: `ShipFlow skills and governance contracts`
