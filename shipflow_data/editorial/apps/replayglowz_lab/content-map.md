...
linked_artifacts:
  ...
  - "shipflow_data/business/apps/replayglowz_lab/gtm.md"
depends_on:
  - artifact: "shipflow_data/business/apps/replayglowz_lab/product.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
  - artifact: "shipflow_data/business/apps/replayglowz_lab/gtm.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
supersedes: []
...
`shipflow_data/editorial/apps/replayglowz_lab/content-map.md` defines where canonical documentation lives for `replayglowz_lab` and what each surface may claim. This repository is backend/experimental; user-facing product truth is handled in `replayglowz-app`.
...
| Product contract | `shipflow_data/business/apps/replayglowz_lab/product.md` | Define worker user, problem, outcomes, scope, and risks | Worker behavior plus explicit boundary to parent product | Worker role in pipeline changes |
| GTM contract | `shipflow_data/business/apps/replayglowz_lab/gtm.md` | Define backend positioning, channels, proof points, and KPIs | Product contract plus distribution reality | Positioning assumptions change |
| Editorial map | `shipflow_data/editorial/apps/replayglowz_lab/content-map.md` | Route docs to the right surface | Current repository structure | A new content surface appears |
...
|---|---|---|---|---|
| Worker purpose and architecture | `README.md` | `shipflow_data/business/apps/replayglowz_lab/product.md`, `server.py` | Understand why the worker exists | live |
...
| Product and positioning decisions | `shipflow_data/business/apps/replayglowz_lab/product.md` | `shipflow_data/business/apps/replayglowz_lab/gtm.md`, `shipflow_data/editorial/apps/replayglowz_lab/content-map.md` | Keep scope and messaging coherent | reviewed |
...
|---|---|
| Provider added or removed | `README.md`, `shipflow_data/business/apps/replayglowz_lab/product.md`, `shipflow_data/business/apps/replayglowz_lab/gtm.md`, `server.py`, `requirements.txt` |
| Endpoint or auth change | `README.md`, `server.py`, deployment notes |
| Deployment model change | `README.md`, `shipflow_data/editorial/apps/replayglowz_lab/content-map.md` |
| New guardrail or warning behavior | `README.md`, `CHANGELOG.md`, `shipflow_data/business/apps/replayglowz_lab/product.md` |
| Parent-product positioning update | `shipflow_data/business/apps/replayglowz_lab/product.md`, `shipflow_data/business/apps/replayglowz_lab/gtm.md`, and boundaries referencing `replayglowz-app` |
