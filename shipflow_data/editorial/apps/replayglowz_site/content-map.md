...
depends_on:
  - artifact: "shipflow_data/business/apps/replayglowz_site/product.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
  - artifact: "shipflow_data/business/apps/replayglowz_site/gtm.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
...
next_step: "/sf-docs audit shipflow_data/editorial/apps/replayglowz_site/content-map.md"
---
...
Canonical product truth remains `replayglowz_app`.
...
| Repo docs | `README.md`, `shipflow_data/business/apps/replayglowz_site/business.md`, `shipflow_data/business/apps/replayglowz_site/branding.md`, `shipflow_data/business/apps/replayglowz_site/product.md`, `shipflow_data/business/apps/replayglowz_site/gtm.md`, `shipflow_data/editorial/apps/replayglowz_site/content-map.md` | Operating contracts for marketing and docs consistency | Root docs |
...
|---|---|
| Product promise changes | `/`, `/features`, `/compare`, `shipflow_data/business/apps/replayglowz_site/product.md`, `shipflow_data/business/apps/replayglowz_site/gtm.md` |
| Offer or pricing changes | `/pricing`, homepage pricing blocks, `shipflow_data/business/apps/replayglowz_site/business.md`, `shipflow_data/business/apps/replayglowz_site/gtm.md` |
| Brand voice/tagline changes | `/`, `/fr`, `shipflow_data/business/apps/replayglowz_site/branding.md`, selected blog intros/outros |
...
When `replayglowz-site` messaging conflicts with canonical product artifacts, resolve in favor of `replayglowz_app`.
