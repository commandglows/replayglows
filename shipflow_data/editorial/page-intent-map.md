...
| --- | --- | --- | --- | --- |
| `/` | Explain ReplayGlowz and convert qualified users to the app. | App signup/open app. | Business, product, brand, GTM. | Shared components and config can affect multiple pages. |
...
| `/compare` | Position ReplayGlowz against alternative workflows. | App/pricing CTA. | Product and GTM contracts. | Competitive claims require proof and careful wording. |
