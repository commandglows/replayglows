...
`shipflow_data/editorial/lab/content-map.md` defines where canonical documentation lives for `lab` and what each surface may claim. This repository is backend/experimental; user-facing product truth is handled in `replayglowz-app`.
