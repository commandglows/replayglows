...
| Work trackers | `shipflow_data/workflow/test-logs/TASKS.md`, `shipflow_data/workflow/test-logs/AUDIT_LOG.md` | Active backlog and audit trace | Markdown | Current work management, not canonical product truth | Work status changes; do not treat as decision contracts |
