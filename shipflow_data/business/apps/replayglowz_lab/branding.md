...
depends_on:
  - "shipflow_data/business/apps/replayglowz_lab/business.md@1.0.0"
supersedes: []
next_review: "2026-05-26"
next_step: "Mirror public brand decisions from replayglowz-app while keeping this repo operational."
---

# shipflow_data/business/apps/replayglowz_lab/branding.md

## Decision Boundary

`replayglowz_lab` is not the public product surface. Public messaging and user-facing brand decisions belong to `replayglowz-app`.
