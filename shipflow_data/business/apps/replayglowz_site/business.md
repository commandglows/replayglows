...
depends_on:
  - artifact: "shipflow_data/business/apps/replayglowz_app/business.md"
    artifact_version: "1.0.0"
...
evidence:
  ...
  - "shipflow_data/business/apps/replayglowz_app/business.md (canonical product business contract)"
...
Canonical product truth lives in `replayglowz_app`. This site can frame, qualify, and convert demand, but it should not introduce business claims that diverge from the app contract.
