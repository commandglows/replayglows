...
next_step: "/sf-docs audit shipflow_data/business/apps/replayglowz_site/product.md"
---
...
Canonical product truth is `shipflow_data/business/apps/replayglowz_app/product.md`. This repository must stay aligned with that contract and avoid introducing a parallel product definition.
...
- Any product-level conflict resolves in favor of `shipflow_data/business/apps/replayglowz_app/product.md`.
