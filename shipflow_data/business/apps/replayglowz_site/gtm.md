...
linked_artifacts:
  ...
  - "shipflow_data/editorial/apps/replayglowz_site/content-map.md"
depends_on:
...
next_step: "/sf-docs audit shipflow_data/business/apps/replayglowz_site/gtm.md"
---
...
This repository is the acquisition and conversion layer for ReplayGlowz. Canonical product truth is maintained in `replayglowz_app`.
...
- Resolve product-level messaging conflicts in favor of `replayglowz_app` artifacts.
