...
evidence:
  - "shipflow_data/business/app/product.md reviewed product scope and claim boundaries"
  - "shipflow_data/business/app/business.md reviewed business direction (LTD + subscription, segments confirmed)"
