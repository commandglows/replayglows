...
- `app/lib/screens/videos/videos_screen.dart` has unimplemented search and filter actions.
- `app/lib/providers/providers.dart` already has `VideosArgs(sortOrder, includeWatched)`.
...
- `app/lib/screens/play/play_screen.dart` supports playback, notes, transcript, queue drawer, progress save, and basic actions.
...
- `app/lib/i18n/en.dart` and `fr.dart` contain TODOs to copy remaining sections.
