...
- checklist_path: `shipglows_data/workflow/audits/replayglowz-virtual-feeds-channel-aggregators-qa.md` if manual QA is recorded as a durable checklist during implementation.
