...
- Update `shipglows_data/workflow/audits/2026-05-26-youtube-edge-case-regression-checklist.md` with final behavior and any provider nuance found during implementation.
...
- If a new backend import contract becomes central, update `app/AGENT.md` or `shipglows_data/technical/architecture.md` only after implementation verifies the final shape.
...
- [x] Task 1: Add playlist source and discovery diagnostics contract.
  - File: `backend/packages/backend/convex/schema.ts`, `backend/packages/backend/convex/youtube.ts`, `app/lib/models/playlist.dart`.
...
- [x] Task 3: Implement authoritative playlist URL/ID parser and error mapper.
  - File: `backend/packages/backend/convex/youtube.ts`, optional new helper module if local pattern allows.
...
- [x] Task 4: Add backend action `youtube:importPlaylistByUrl`.
  - File: `backend/packages/backend/convex/youtube.ts`, `backend/packages/backend/convex/metrics.ts` if needed.
...
- [x] Task 5: Wire Flutter mutation helper and provider invalidation.
  - File: `app/lib/providers/mutations.dart`, `app/lib/providers/providers.dart` if a status provider is needed.
...
- [x] Task 6: Add reusable YouTube channel/import onboarding widget.
  - File: `app/lib/widgets/`, likely new `youtube_channel_onboarding.dart` or integrated `youtube_connect_ui_states.dart`.
...
- [x] Task 7: Wire onboarding into Playlists, Videos and Preferences.
  - File: `app/lib/screens/playlists/playlists_screen.dart`, `app/lib/screens/videos/videos_screen.dart`, `app/lib/screens/preferences/preferences_screen.dart`, `app/lib/widgets/youtube_connect_ui_states.dart`.
...
- [x] Task 8: Add EN/FR i18n copy.
  - File: `app/lib/i18n/en.dart`, `app/lib/i18n/fr.dart`, `app/lib/i18n/translations.dart`.
...
- Read first:
  ...
  - `app/lib/providers/mutations.dart`
  - `app/lib/screens/playlists/playlists_screen.dart`
  - `shipglows_data/workflow/audits/2026-05-26-youtube-edge-case-regression-checklist.md`
