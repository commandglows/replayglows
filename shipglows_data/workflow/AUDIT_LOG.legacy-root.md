...
🟠 [replayglowz] design-system authority baseline | date: 2026-06-12 | overall: C | issues: 510 findings (app) / 70 findings (site); scope: app, site | authority baseline captured in `shipglows_data/technical/design-system-authority.md`
