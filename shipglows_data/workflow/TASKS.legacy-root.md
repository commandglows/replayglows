...
🟡 [replayglows] task: Review the direct major dependency lanes before upgrading `youtube_player_flutter`, `openai`, and transcript-worker ML/tooling packages | status: todo | area: deps | next: /sf-migrate ReplayGlows dependency major upgrade lanes
