...
`ReplayGlows helps people learn from video by keeping notes attached to exact playback context.`
...
- Any product-level conflict resolves in favor of `shipglows_data/product/app/product.md`.
