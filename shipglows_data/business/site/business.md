...
value_proposition: "ReplayGlows turns watch time into organized learning with timestamped notes, retrieval, and focused review."
...
depends_on:
  - artifact: "shipglows_data/business/app/business.md"
    artifact_version: "1.0.0"
...
`replayglows-site` is the acquisition and conversion surface for ReplayGlows. It is not the canonical product contract.

Canonical product truth lives in `app`. This site can frame, qualify, and convert demand, but it should not introduce business claims that diverge from the app contract.
...
ReplayGlows sits between algorithm-first video consumption and disconnected note-taking tools. The differentiation is preserving learning context at source timestamp granularity while reducing friction to retrieval.
