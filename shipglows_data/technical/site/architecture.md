...
`replayglows-site` is an Astro-based marketing site. Its architecture is static-first, with minimal client-side enhancement and no visible server-side business logic beyond Astro build-time content generation and an RSS route.
