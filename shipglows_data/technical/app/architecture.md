...
- On mobile Play, `AppShell` can replace the normal bottom navigation with playback controls after a long press or temporary Play activation, and can slide advanced controls above the bottom navigation after an upward swipe from Play.
