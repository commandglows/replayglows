...
next_step: "Align these repository guidelines with the main ReplayGlows engineering standards if a shared standard exists."
---
...
- Any change to request fields, response fields, auth behavior, or status-code semantics must be coordinated with the calling ReplayGlows app.
