...
depends_on:
  - artifact: "shipglows_data/product/lab/product.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
  - artifact: "shipglows_data/gtm/lab/gtm.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
supersedes: []
...
| Product contract | `shipglows_data/product/lab/product.md` | Define worker user, problem, outcomes, scope, and risks | Worker behavior plus explicit boundary to parent product | Worker role in pipeline changes |
| GTM contract | `shipglows_data/gtm/lab/gtm.md` | Define backend positioning, channels, proof points, and KPIs | Product contract plus distribution reality | Positioning assumptions change |
| Editorial map | `shipglows_data/editorial/lab/content-map.md` | Route docs to the right surface | Current repository structure | A new content surface appears |
...
|---|---|---|---|---|
| Worker purpose and architecture | `README.md` | `shipglows_data/product/lab/product.md`, `server.py` | Understand why the worker exists | live |
...
| Product and positioning decisions | `shipglows_data/product/lab/product.md` | `shipglows_data/gtm/lab/gtm.md`, `shipglows_data/editorial/lab/content-map.md` | Keep scope and messaging coherent | reviewed |
...
|---|---|
| Provider added or removed | `README.md`, `shipglows_data/product/lab/product.md`, `shipglows_data/gtm/lab/gtm.md`, `server.py`, `requirements.txt` |
