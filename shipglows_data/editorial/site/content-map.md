...
| Repo docs | `README.md`, `shipglows_data/business/site/business.md`, `shipglows_data/branding/branding.md`, `shipglows_data/product/site/product.md`, `shipglows_data/gtm/site/gtm.md`, `shipglows_data/editorial/site/content-map.md` | Operating contracts for marketing and docs consistency | Root docs |
...
|---|---|
| Product promise changes | `/`, `/features`, `/compare`, `shipglows_data/product/site/product.md`, `shipglows_data/gtm/site/gtm.md` |
| Offer or pricing changes | `/pricing`, homepage pricing blocks, `shipglows_data/business/site/business.md`, `shipglows_data/gtm/site/gtm.md` |
| Brand voice/tagline changes | `/`, `/fr`, `shipglows_data/branding/branding.md`, selected blog intros/outros |
